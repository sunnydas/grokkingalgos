...
Given a Binary Tree, we need to print the bottom view from left to right. A next x is there in output if x is the bottommost next at its horizontal distance. Horizontal distance of left child of a next x is equal to horizontal distance of x minus 1, and that of right child is horizontal distance of x plus 1.
